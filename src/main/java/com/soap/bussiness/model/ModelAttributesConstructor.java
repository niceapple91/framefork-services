...
public class ModelAttributesConstructor {
    ...
    public CreateNewModels.CreateNewModel createModel(Map<String, Object> attributesModel, String rangePlanId){
        CreateNewModels.CreateNewModel newModel = new CreateNewModels.CreateNewModel();
        ...
        newModel.getProductManagerName((String)attributesModel.get("productManagerName"));
        ...
        newModel.setDevelopmentTypeCode((String)attributesModel.get("developmentTypeCodeTN"));
