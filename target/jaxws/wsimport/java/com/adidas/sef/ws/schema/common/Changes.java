 ...
 *       &lt;sequence>
 *         &lt;element name="changeInfo" type="{http://www.adidas.com/sef/ws/schema/common}ChangeInfo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Changes {
    ...
    protected List<ChangeInfo> changeInfo;
    ...
    public List<ChangeInfo> getChangeInfo() {
        if (changeInfo == null) {
            changeInfo = new ArrayList<ChangeInfo>();
        }
